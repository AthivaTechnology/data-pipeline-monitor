Views.lineage = async function (container) {
  container.innerHTML = `
    ${Utils.pageHeader({
      ...
      metaHtml: `<span class="pill">Discovery module</span>`,
    })}

    <div class="state-box card-style">
      <div class="big">Coming in next phase</div>
      <div>This module has no backend yet — no AWS resource inventory, relationships, or graph data exist. Nothing below is real data; it previews what this page is designed to show once the discovery backend is built.</div>
    ...
    <div class="section">
      <h3>Example Future Graph <span class="pill">Illustrative only — not real data</span></h3>
